...
a persistence unit "EXAMENMurilloJordanPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "EXAMENMurilloJordan\pom.xml":
...
artifact ("EXAMENMurilloJordan.war") is already built. You can build
